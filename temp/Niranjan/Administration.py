...
def Administration():
    ...
    button_Add_member = Button(root, text="ADD NEW MEMBER", font=("D3 Euronism Bold", 18), command=login, height=3,
                                width=13, bd=7, bg="#2b2d42", fg="white", cursor="hand2", activebackground='#2b2d42', activeforeground="white")
    button_Add_member.place(x=1000, y=300, width=340, height=203)

    button_Delete_member = Button(root, text="DELETE A MEMBER", command=login, font=("D3 Euronism Bold", 18), height=3, width=13,
