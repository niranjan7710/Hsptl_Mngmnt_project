...
Label(F_pd_del, bg="Black", fg="white", text="A project by Niranjan S, Hari Prasad, Yasus & Ammu Krishna (2022-23 batch)",
...
label_title_1 = Label(F_pd_del, bd=5, relief=RIDGE, text="PATIENT DETAILS",
                    fg="red", bg="#212121", font=("akrobat black", 30, "bold", ))
label_title_1.pack(side=TOP, fill=X)


frame = Frame(F_pd_del, bg="#f1f1f1")
...
Label(frame, fg="black", text="Patient ID", font=(
...
def conf_del():
    frame1 = Frame(frame,bd=5, bg="white") 
    ...
    e = Label(frame1, width=14, text='Patient_ID', borderwidth=3, font=(
...
#    e.grid_columnconfigure(1,weight=2)
    ...
    e = Label(frame1, width=14, text='sex', borderwidth=3, font=(
        "Cascadia Code", 13), relief='ridge', anchor='w', bg='yellow')
...
#    e.grid_columnconfigure(5,weight=2)
    ...
    for doctors in x:
        for j in range(len(doctors)):
            e = Label(frame1, width=20, text=doctors[j], borderwidth=3, font=(
...
chk_str = StringVar()
l5 = Label(frame, textvariable=chk_str, width=10)
l5.pack(side=BOTTOM, fill=X)
...
Label(F_pd_add, bg="Black", fg="white", text="A project by Niranjan S, Hari Prasad, Yasus & Ammu Krishna (2022-23 batch)",
    font=("cascadia code", 20,), justify=CENTER, cursor="xterm").place(x=405, y=990)

engine = sqlalchemy.create_engine('mysql+pymysql://root:vyasa@localhost/hospital_management')
con = engine.connect()

frame = Frame(F_pd_add, bg="#f1f1f1")
frame.place(x=400, y=225, width=1180, height=620)
...
Label(frame, fg="black", text="Patient Name", font=(
...
Label(frame, fg="black", text="sex", font=(
...
Label(frame, fg="black", text="age", font=(
...
Label(frame, fg="black", text="Address", font=(
...
Label(frame, fg="black", text="Phone Number", font=(
...
button_add = Button(frame, text="Add New Patient", font=("cascadia code", 18), command=lambda: add_data(), height=3,
...
def F_pd_id():
    ...
    def dis_id():
        frame1 = Frame(frame,bd=5,bg="#f1f1f1")
...
def F_pd_sex():
    ...
    Label(frame, fg="black", text="Enter SEX", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=50)
    sex = Entry(frame, font=("cascadia code mono", 16, "bold"),
                    bg="#2b2d42", fg="white", bd=5, justify='center')
...
def F_pd_age():
    ...
    Label(frame, fg="black", text="Enter AGE", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=50)
    age = Entry(frame, font=("cascadia code mono", 16, "bold"),
                    bg="#2b2d42", fg="white", bd=5, justify='center')
...
button_Exit = Button(lblfrm, text="Go Back", font=("cascadia code", 18), height=3, width=13, command=lambda: swap(F_pd_add),
                        bd=7, bg="#2b2d42", fg="white", cursor="hand2", activebackground='#2b2d42', activeforeground="white")
...
def del_doc():
    ...
    Label(frame, fg="black", text="Doctor ID", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=50)
...
def del_nurse():
    ...
    Label(frame, fg="black", text="NURSE ID", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=50)
    Doc_ID = Entry(frame, font=("cascadia code mono", 16, "bold"),
                    bg="#2b2d42", fg="white", bd=5, justify='center')
    Doc_ID.place(x=550, y=50, width=290, height=33)
...
def add_doc():
    ...
    Label(frame, fg="black", text="Doctor Name", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=85)
    name = Entry(frame, font=("cascadia code mono", 16, "bold"),
                bg="#2b2d42", fg="white", bd=5, justify='center')
    name.place(x=550, y=85, width=290, height=33)

    Label(frame, fg="black", text="spc", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=120)
    ...
    Label(frame, fg="black", text="Fees", font=(
    ...
    Label(frame, fg="black", text="Monthly salary", font=(
...
def add_nurse():
    ...
    Label(frame, fg="black", text="Nurse Name", font=(
        "akrobat ", 20, "bold",), justify=RIGHT, cursor="xterm").place(x=320, y=85)
    name = Entry(frame, font=("cascadia code mono", 16, "bold"),
                bg="#2b2d42", fg="white", bd=5, justify='center')
    name.place(x=550, y=85, width=290, height=33)
...
#    e.grid_columnconfigure(7,weight=2)
    ...
    button_Exit = Button(frame, text="Go Back", command=lambda: swap(F_adm_dis), font=("cascadia code", 18), height=3, width=13,
                    bd=7, bg="#2b2d42", fg="white", cursor="hand2", activebackground='#2b2d42', activeforeground="white")
    button_Exit.place(x=400, y=610, width=390, height=53)
...
Label(F_adm_dis, bg="Black", fg="white", text="A project by Niranjan S, Hari Prasad, Yasus & Ammu Krishna (2022-23 batch)",
      font=("cascadia code", 20,), justify=CENTER, cursor="xterm").place(x=200, y=1000)
...
def login():
   ...
   # swap(F_Home)
    ...
    try:
        ...
        mycursor.execute("create table if not exists patient_details(Patient_ID int(7) Primary key,name varchar(30) NOT NULL, sex varchar(6) NOT NULL,age int(2) NOT NULL,address varchar(50) NOT NULL,contact int(10) NOT NULL)")
        mycursor.execute("create table if not exists doctor_details(Doc_ID int(4) primary key, name varchar(30) NOT NULL,specialisation varchar(40) NOT NULL,age int(2) NOT NULL,address varchar(30),contact int(10) NOT NULL,fees int(10) NOT NULL,monthly_salary int(10) NOT NULL)")
        mycursor.execute("create table if not exists nurse_details(Nurse_ID int(5) primary key,name varchar(30) NOT NULL,age int(2) NOT NULL,address varchar(30),contact int(15) NOT NULL,monthly_salary int(10) NOT NULL)")
